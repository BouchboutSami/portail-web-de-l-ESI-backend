...
export interface ApiDomainePrestationDomainePrestation
  extends Schema.CollectionType {
  collectionName: 'domaine_prestations';
  info: {
    singularName: 'domaine-prestation';
    pluralName: 'domaine-prestations';
    displayName: 'domainePrestation';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    nameDomaine: Attribute.String;
    formations: Attribute.Relation<
      'api::domaine-prestation.domaine-prestation',
      'oneToMany',
      'api::formation.formation'
    >;
    createdAt: Attribute.DateTime;
...
export interface ApiFormationFormation extends Schema.CollectionType {
  ...
  attributes: {
    ...
    description: Attribute.Text;
    tarif: Attribute.Integer;
    domaine_prestation: Attribute.Relation<
      'api::formation.formation',
      'manyToOne',
      'api::domaine-prestation.domaine-prestation'
    >;
    formateurs: Attribute.Relation<
      'api::formation.formation',
      'manyToMany',
      'api::formateur.formateur'
    >;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::domaine-prestation.domaine-prestation': ApiDomainePrestationDomainePrestation;
